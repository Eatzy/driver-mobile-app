...
function scene:create(event)
	...
	backgroundBox:setFillColor(
		parameters.GRAPHICS.COLORS["background"][1],
		parameters.GRAPHICS.COLORS["background"][2],
		parameters.GRAPHICS.COLORS["background"][3]
	)
	...
	businessName =
		textmaker.newText(driverBusinessDetails["name"], 0, 0, {"roboto-thin"}, parameters.GRAPHICS.FONT_BASE_SIZE * 2)
	businessName:setFillColor(
		parameters.GRAPHICS.COLORS["main_text"][1],
		parameters.GRAPHICS.COLORS["main_text"][2],
		parameters.GRAPHICS.COLORS["main_text"][3]
	)
	businessName.anchorX = 0.5
	businessName.anchorY = 0.0
	businessName.x = _CX
	businessName.y = device.safeYOffset + _H*0.15
	...
	logoutButtonBg.y = _H - navButtonHeight * 0.5 - 20

	local logoutButtonText =
		textmaker.newText(parameters.GRAPHICS.TEXT["logout"], 0, 0, {navButtonFontName}, navButtonFontSize)
	logoutButtonText:setFillColor(
		parameters.GRAPHICS.COLORS["button_logout_text"][1],
		parameters.GRAPHICS.COLORS["button_logout_text"][2],
		parameters.GRAPHICS.COLORS["button_logout_text"][3]
	)
	...
	local function onLogout(event)
		...
		elseif ("ended" == event.phase) then
			...
			local alert =
				native.showAlert(
				parameters.GRAPHICS.TEXT["logout_alert_title"],
				parameters.GRAPHICS.TEXT["logout_alert_body"],
				{parameters.GRAPHICS.TEXT["alert_cancel"], parameters.GRAPHICS.TEXT["alert_ok"]},
				onAlert
			)
		end
	end

	local logoutButtonAction =
		widget.newButton {
	...
	clockinButtonBg.y = logoutButtonBg.y - navButtonHeight - 10

	local clockinButtonText =
		textmaker.newText(parameters.GRAPHICS.TEXT["clockin"], 0, 0, {navButtonFontName}, navButtonFontSize)
	clockinButtonText:setFillColor(
		parameters.GRAPHICS.COLORS["button_clockin_text"][1],
		parameters.GRAPHICS.COLORS["button_clockin_text"][2],
		parameters.GRAPHICS.COLORS["button_clockin_text"][3]
	)
