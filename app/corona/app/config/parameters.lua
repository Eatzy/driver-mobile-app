...
M.GENERAL.VERSION = "1.7.3";
M.GENERAL.BUILD = "107003";
...
local greenColor = {(39/255),(174/255),(96/255)};
local orangeColor = {(230/255),(126/255),(34/255)};
local redColor = {(192/255),(57/255),(43/255)};
...
M.GRAPHICS.COLORS["button_login_over"] = greenColor;
...
M.GRAPHICS.COLORS["button_logout_over"] = redColor;
...
M.GRAPHICS.COLORS["button_register_over"] = greenColor;
...
M.GRAPHICS.COLORS["button_clockin_over"] = greenColor;
...
M.GRAPHICS.COLORS["button_clockout_over"] = orangeColor;
...
M.GRAPHICS.COLORS["button_action_over"] = orangeColor; -- navigation button over color
...
M.GRAPHICS.COLORS["button_update_over"] = orangeColor;
